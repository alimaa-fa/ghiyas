package ghiyas.alimaa.fa.export

import ghiyas.alimaa.fa.domain.config.AppLinksConfig
import ghiyas.alimaa.fa.domain.export.TextExportFormatter
...
object WebExportEngine {
    ...
    fun shareImage(record: CalculationHistoryRecord) {
        ...
        fun appendSection(title: String, items: List<ghiyas.alimaa.fa.domain.models.ResultItem>) {
